...
from show1.models.unet import UNet3DConditionModel
# from tuneavideo.data.dataset import TuneAVideoDataset
from show1.pipelines.pipeline_tuneavideo import TextToVideoIFPipeline
...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    validation_pipeline = TextToVideoIFPipeline(
